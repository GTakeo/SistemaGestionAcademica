...
public class PaginaUtil {
	...
	public static String obtenerNombreMes(Integer anio, Integer mes) {
		...
		nombreMes = Character.toUpperCase(primeraLetra) + nombreMes.substring(1, nombreMes.length());
		return nombreMes;
	}
	...
	public static String obtenerNavegador() {
		String browser = ((HttpServletRequest) FacesContext.getCurrentInstance().getExternalContext().getRequest())
	...
	public static void actualizarComponenteMensaje(String idComponente, int severidad, String titulo, String mensaje) {
